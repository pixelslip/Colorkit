...
// Colorkit
#define COCOAPODS_POD_AVAILABLE_Colorkit
#define COCOAPODS_VERSION_MAJOR_Colorkit 0
#define COCOAPODS_VERSION_MINOR_Colorkit 1
#define COCOAPODS_VERSION_PATCH_Colorkit 0
